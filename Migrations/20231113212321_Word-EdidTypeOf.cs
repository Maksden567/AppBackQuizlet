...
{
    /// <inheritdoc />
    public partial class WordEdidTypeOf : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isKnowen = table.Column<bool>(type: "bit", nullable: true),
                    LibraryEnglishId1 = table.Column<int>(type: "int", nullable: true),
                    LibraryEnglishId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
